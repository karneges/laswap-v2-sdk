...
var e = t(require('jsbi')),
  ...
  u = require('@ethersproject/abi'),
  i = require('@ethersproject/address'),
  s = '0xb90691ba2b76d31a708f1044cd9cbfc3201ff667eb93bf0e72e6aa7ea5268f14',
  a = e.BigInt(1e3),
  c = e.BigInt(0),
  p = e.BigInt(1),
  l = e.BigInt(5),
...
var I = 'setPrototypeOf' in Object,
  x = (function(t) {
    function e() {
      ...
      return (
        ...
        I && Object.setPrototypeOf(g(n), (this instanceof e ? this.constructor : void 0).prototype),
        n
      )
    }
    return y(e, t), e
  ...
  E = function(t) {
    ...
    return i.getCreate2Address(
      e,
      o.keccak256(['bytes'], [u.defaultAbiCoder.encode(['address', 'address'], [a[0].address, a[1].address])]),
      s
    )
  },
  P = (function() {
    ...
    t.getAddress = function(t, e) {
      return E({ factoryAddress: '0x7ffFc72b22a3A39f471574BEEDC0135767Bf344a', tokenA: t, tokenB: e })
    }
    var o = t.prototype
    return (
      ...
      (o.getOutputAmount = function(o) {
        ...
        var u = this.reserveOf(o.currency),
          ...
          s = e.multiply(o.quotient, f),
          a = e.multiply(s, i.quotient),
          p = e.add(e.multiply(u.quotient, m), s),
          l = n.CurrencyAmount.fromRawAmount(o.currency.equals(this.token0) ? this.token1 : this.token0, e.divide(a, p))
        if (e.equal(l.quotient, c)) throw new O()
      ...
      (o.getLiquidityMinted = function(t, o, u) {
        ...
        var i,
          s = o.currency.sortsBefore(u.currency) ? [o, u] : [u, o]
        if (((s[0].currency.equals(this.token0) && s[1].currency.equals(this.token1)) || r(!1), e.equal(t.quotient, c)))
          i = e.subtract(n.sqrt(e.multiply(s[0].quotient, s[1].quotient)), a)
        else {
          var p = e.divide(e.multiply(s[0].quotient, t.quotient), this.reserve0.quotient),
            l = e.divide(e.multiply(s[1].quotient, t.quotient), this.reserve1.quotient)
          i = e.lessThanOrEqual(p, l) ? p : l
        }
        if (!e.greaterThan(i, c)) throw new O()
          ...
          if (e.equal(p, c)) a = o
            ...
            if (e.greaterThan(f, m)) {
              var h = e.multiply(o.quotient, e.subtract(f, m)),
                d = e.add(e.multiply(f, l), m),
                y = e.divide(h, d)
              a = o.add(n.CurrencyAmount.fromRawAmount(this.liquidityToken, y))
            } else a = o
          }
        } else a = o
        return n.CurrencyAmount.fromRawAmount(
          t,
          e.divide(e.multiply(u.quotient, this.reserveOf(t).quotient), a.quotient)
        )
      }),
      d(t, [
        {
      ...
      d(t, [
        {
          ...
          get: function() {
            ...
            for (var t, e = [], r = b(this.pairs.entries()); !(t = r()).done; ) {
              var o = t.value,
                u = o[1]
              e.push(
...
var F = (function() {
  ...
  return (
    ...
    (t.bestTradeExactIn = function(e, o, u, i, s, a, p) {
      var l = void 0 === i ? {} : i,
        f = l.maxNumResults,
        m = void 0 === f ? 3 : f,
        h = l.maxHops,
      ...
      void 0 === s && (s = []),
        ...
        d > 0 || r(!1),
        o === a || s.length > 0 || r(!1)
      for (var y = a.wrapped, v = u.wrapped, T = 0; T < e.length; T++) {
        var A = e[T]
        if (
          (A.token0.equals(y.currency) || A.token1.equals(y.currency)) &&
          !A.reserve0.equalTo(c) &&
          !A.reserve1.equalTo(c)
        ) {
          var q = void 0
          try {
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new _([].concat(s, [A]), o.currency, u), o, n.TradeType.EXACT_INPUT), m, R)
    ...
    (t.bestTradeExactOut = function(e, o, u, i, s, a, p) {
      var l = void 0 === i ? {} : i,
        f = l.maxNumResults,
        m = void 0 === f ? 3 : f,
        h = l.maxHops,
      ...
      void 0 === s && (s = []),
        ...
        d > 0 || r(!1),
        u === a || s.length > 0 || r(!1)
      for (var y = a.wrapped, v = o.wrapped, T = 0; T < e.length; T++) {
        var A = e[T]
        if (
          (A.token0.equals(y.currency) || A.token1.equals(y.currency)) &&
          !A.reserve0.equalTo(c) &&
          ...
          if (q.currency.equals(v))
            n.sortedInsert(p, new t(new _([A].concat(s), o, u.currency), u, n.TradeType.EXACT_OUTPUT), m, R)
          else if (d > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
